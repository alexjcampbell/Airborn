...
{
    public class PlanFlightController : Controller
    {
        private readonly ILogger<PlanFlightController> _logger;
        ...
        public PlanFlightController(ILogger<PlanFlightController> logger, IWebHostEnvironment env, AirbornDbContext dbContext)
        {
            _logger = logger;
            _env = env;
