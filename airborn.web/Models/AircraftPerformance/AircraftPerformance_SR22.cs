...
{
    public abstract class AircraftPerformance_SR22 : AircraftPerformanceBase
    {

        public AircraftPerformance_SR22(Scenario scenario, string path) : base(scenario, path)
        {
        }
